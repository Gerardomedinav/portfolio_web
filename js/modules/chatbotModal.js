      ...
      <div id="gerassist-messages" class="bot-messages-container">
        ...
        <div class="bot-message-wrapper bot-message--bot">
          ...
          <div class="bot-msg-bubble">
            ${lang === 'es' 
              ? '¡Hola! 👋 Qué gusto saludarte. Soy <strong>GerAssist</strong>, el asistente personal de <strong>Gerardo Medina</strong>.<br /><br />Estoy aquí para acompañarte y responder todo lo que quieras saber sobre Gerardo: su perfil como <strong>Desarrollador Full Stack & Analista de Datos (Data Scientist)</strong>, su pasión por la <strong>Accesibilidad (WCAG 2.1 AA)</strong>, sus estudios en la <strong>UTN</strong> o la historia e impacto de sus proyectos.<br /><br />¿Te gustaría contactar o fijar una cita con Gerardo? Puedo guiarte paso a paso para enviarle una nota de tu interés por el formulario de contacto o conectar directamente por LinkedIn. ¿Por dónde te gustaría empezar?' 
              : "Hi! 👋 Great to meet you. I am <strong>GerAssist</strong>, Gerardo Medina's personal AI assistant.<br /><br />I am here to guide you and answer anything you'd like to know about Gerardo: his <strong>Full Stack & Data Analyst / Data Scientist</strong> profile, his commitment to <strong>Accessibility (WCAG 2.1 AA)</strong>, his <strong>UTN</strong> studies, or his project portfolio.<br /><br />Would you like to contact or schedule a meeting with Gerardo? I can guide you step by step to send him a note via the contact form or connect directly on LinkedIn. Where would you like to start?"}
          </div>
        </div>
